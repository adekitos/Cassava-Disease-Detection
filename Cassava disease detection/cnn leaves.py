...
labels = ['LOOP_cbb', 'LOOP_cbsd', 'LOOP_cgm', 'LOOP_cmd', 'LOOP_healthy'] 
img_size = 224
...
train = get_data('C:/Users/Adekitos/Desktop/Olawale_CNN/LOOP/LOOP_train')
val = get_data('C:/Users/Adekitos/Desktop/Olawale_CNN/LOOP/LOOP_test')
...
train_generator = train_datagen.flow_from_directory('C:\\Users\\Adekitos\\Desktop\\Olawale binary images\\LOOP\\LOOP_train', target_size=(224, 224), class_mode='binary')
...
validation_generator = validation_datagen.flow_from_directory('C:\\Users\\Adekitos\\Desktop\\Olawale binary images\\LOOP\\LOOP_test', target_size=(224, 224), class_mode='binary')
...
print(classification_report(y_val, predictions, target_names = ['LOOP_cbb (class 0)', 'LOOP_cbsd (class 1)', 'LOOP_cgm (class 2)', 'LOOP_cmd (class 3)', 'LOOP_healthy (class 4)']))
