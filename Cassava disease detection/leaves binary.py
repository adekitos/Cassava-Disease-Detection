...
labels = ['LOOP_disease', 'LOOP_healthy'] 
img_size = 224
...
train = get_data('C:/Users/Adekitos/Desktop/Olawale binary images/LOOP/LOOP_train')
val = get_data('C:/Users/Adekitos/Desktop/Olawale binary images/LOOP/LOOP_test')
...
print(classification_report(y_val, predictions, target_names = ['LOOP_disease (class 0)', 'LOOP_healthy (class 1)']))
